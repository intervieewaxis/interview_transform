...
export const CustomFieldsSection = ({ className }: Props) => {
  ...
  const customFields = useResumeStore((state) => state.resume.data.basics?.customFields ?? state.resume.data.basics.customFields);
        ...
        >
          {customFields.map((field) => (
            ...
            <CustomField
              key={field.id}
              field={{
                id: field.id || createId(), // Ensure `id` is always defined
                icon: field.icon || "", // Ensure `icon` is always defined
                name: field.name || "", // Ensure `name` is always defined
                value: field.value || "", // Ensure `value` is always defined
                label: field.label || "", // Ensure `label` is always defined
                href: field.href || "", // Ensure `href` is always defined
              }}
