...
const Summary = () => {
    ...
    if (!section.visible || (0, utils_1.isEmptyString)(section.content))
        return null;
    return ((0, jsx_runtime_1.jsxs)("section", { id: section.id, children: [(0, jsx_runtime_1.jsx)("div", { className: "mb-2 hidden font-bold text-primary group-[.main]:block", children: (0, jsx_runtime_1.jsx)("h4", { children: section.name }) }), (0, jsx_runtime_1.jsxs)("div", { className: "mb-2 hidden items-center gap-x-2 text-center font-bold text-primary group-[.sidebar]:flex", children: [(0, jsx_runtime_1.jsx)("div", { className: "size-1.5 rounded-full border border-primary" }), (0, jsx_runtime_1.jsx)("h4", { children: section.name }), (0, jsx_runtime_1.jsx)("div", { className: "size-1.5 rounded-full border border-primary" })] }), (0, jsx_runtime_1.jsxs)("main", { className: (0, utils_1.cn)("relative space-y-2", "border-l border-primary pl-4"), children: [(0, jsx_runtime_1.jsx)("div", { className: "absolute left-[-4.5px] top-[8px] hidden size-[8px] rounded-full bg-primary group-[.main]:block" }), (0, jsx_runtime_1.jsx)("div", { dangerouslySetInnerHTML: { __html: section.content }, className: "wysiwyg", style: { columns: section.columns } })] })] }));
};
const Rating = ({ level }) => ((0, jsx_runtime_1.jsxs)("div", { className: "relative h-1 w-[128px] group-[.sidebar]:mx-auto", children: [(0, jsx_runtime_1.jsx)("div", { className: "absolute inset-0 h-1 w-[128px] rounded bg-primary opacity-25" }), (0, jsx_runtime_1.jsx)("div", { className: "absolute inset-0 h-1 rounded bg-primary", style: { width: (0, utils_1.linearTransform)(level, 0, 5, 0, 128) } })] }));
...
const Section = ({ section, children, className, urlKey, levelKey, summaryKey, keywordsKey, }) => {
    if (!section.visible || section.items.length === 0)
        return null;
    return ((0, jsx_runtime_1.jsxs)("section", { id: section.id, className: "grid", children: [(0, jsx_runtime_1.jsx)("div", { className: "mb-2 hidden font-bold text-primary group-[.main]:block", children: (0, jsx_runtime_1.jsx)("h4", { children: section.name }) }), (0, jsx_runtime_1.jsxs)("div", { className: "mx-auto mb-2 hidden items-center gap-x-2 text-center font-bold text-primary group-[.sidebar]:flex", children: [(0, jsx_runtime_1.jsx)("div", { className: "size-1.5 rounded-full border border-primary" }), (0, jsx_runtime_1.jsx)("h4", { children: section.name }), (0, jsx_runtime_1.jsx)("div", { className: "size-1.5 rounded-full border border-primary" })] }), (0, jsx_runtime_1.jsx)("div", { className: "grid gap-x-6 gap-y-3 group-[.sidebar]:mx-auto group-[.sidebar]:text-center", style: { gridTemplateColumns: `repeat(${section.columns}, 1fr)` }, children: section.items
                    ...
                    return ((0, jsx_runtime_1.jsxs)("div", { className: (0, utils_1.cn)("relative space-y-2", "border-primary group-[.main]:border-l group-[.main]:pl-4", className), children: [(0, jsx_runtime_1.jsx)("div", { children: children === null || children === void 0 ? void 0 : children(item) }), summary !== undefined && !(0, utils_1.isEmptyString)(summary) && ((0, jsx_runtime_1.jsx)("div", { dangerouslySetInnerHTML: { __html: summary }, className: "wysiwyg" })), level !== undefined && level > 0 && (0, jsx_runtime_1.jsx)(Rating, { level: level }), keywords !== undefined && keywords.length > 0 && ((0, jsx_runtime_1.jsx)("p", { className: "text-sm", children: keywords.join(", ") })), url !== undefined && section.separateLinks && (0, jsx_runtime_1.jsx)(Link, { url: url }), (0, jsx_runtime_1.jsx)("div", { className: "absolute left-[-4.5px] top-px hidden size-[8px] rounded-full bg-primary group-[.main]:block" })] }, item.id));
                }) })] }));
};
const Profiles = () => {
...
const Custom = ({ id }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Section, { section: section, urlKey: "url", summaryKey: "summary", keywordsKey: "keywords", children: (item) => ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(LinkedEntity, { name: item.name, url: item.url, separateLinks: section.separateLinks, className: "font-bold" }), (0, jsx_runtime_1.jsx)("div", { children: item.description }), (0, jsx_runtime_1.jsx)("div", { className: "font-bold", children: item.date }), (0, jsx_runtime_1.jsx)("div", { children: item.location })] }) })) }));
};
...
const Azurill = ({ columns, isFirstPage = false }) => {
    const [main, sidebar] = columns;
    return ((0, jsx_runtime_1.jsxs)("div", { className: "p-custom space-y-3", children: [isFirstPage && (0, jsx_runtime_1.jsx)(Header, {}), (0, jsx_runtime_1.jsxs)("div", { className: "grid grid-cols-3 gap-x-4", children: [(0, jsx_runtime_1.jsx)("div", { className: "sidebar group space-y-4", children: sidebar.map((section) => ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: mapSectionToComponent(section) }, section))) }), (0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("main group space-y-4", sidebar.length > 0 ? "col-span-2" : "col-span-3"), children: main.map((section) => ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: mapSectionToComponent(section) }, section))) })] })] }));
};
