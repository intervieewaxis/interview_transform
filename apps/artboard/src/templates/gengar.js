...
const Header = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "p-custom space-y-4 bg-primary text-background", children: [(0, jsx_runtime_1.jsx)(picture_1.Picture, { className: "border-background" }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h2", { className: "text-2xl font-bold", children: basics.name }), (0, jsx_runtime_1.jsx)("p", { children: basics.headline })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col items-start gap-y-2 text-sm", children: [basics.location && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-x-1.5", children: [(0, jsx_runtime_1.jsx)("i", { className: "ph ph-bold ph-map-pin" }), (0, jsx_runtime_1.jsx)("div", { children: basics.location })] })), basics.phone && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-x-1.5", children: [(0, jsx_runtime_1.jsx)("i", { className: "ph ph-bold ph-phone" }), (0, jsx_runtime_1.jsx)("a", { href: `tel:${basics.phone}`, target: "_blank", rel: "noreferrer", children: basics.phone })] })), basics.email && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-x-1.5", children: [(0, jsx_runtime_1.jsx)("i", { className: "ph ph-bold ph-at" }), (0, jsx_runtime_1.jsx)("a", { href: `mailto:${basics.email}`, target: "_blank", rel: "noreferrer", children: basics.email })] })), (0, utils_1.isUrl)(basics.url.href) && (0, jsx_runtime_1.jsx)(Link, { url: basics.url }), basics.customFields.map((item) => ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-x-1.5", children: [(0, jsx_runtime_1.jsx)("i", { className: (0, utils_1.cn)(`ph ph-bold ph-${item.icon}`) }), (0, utils_1.isUrl)(item.value) ? ((0, jsx_runtime_1.jsx)("a", { href: item.value, target: "_blank", rel: "noreferrer noopener nofollow", children: item.name || item.value })) : ((0, jsx_runtime_1.jsx)("span", { children: [item.name, item.value].filter(Boolean).join(": ") }))] }) }, item.id)))] })] }));
};
const Summary = () => {
    ...
    if (!section.visible || (0, utils_1.isEmptyString)(section.content))
        return null;
    return ((0, jsx_runtime_1.jsx)("div", { className: "p-custom space-y-4", style: { backgroundColor: (0, utils_1.hexToRgb)(primaryColor, 0.2) }, children: (0, jsx_runtime_1.jsx)("section", { id: section.id, children: (0, jsx_runtime_1.jsx)("div", { dangerouslySetInnerHTML: { __html: section.content }, className: "wysiwyg", style: { columns: section.columns } }) }) }));
};
const Rating = ({ level }) => ((0, jsx_runtime_1.jsx)("div", { className: "flex items-center gap-x-1", children: Array.from({ length: 5 }).map((_, index) => ((0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("h-2.5 w-5 border border-primary", level > index && "bg-primary") }, index))) }));
const Link = ({ url, icon, iconOnRight, label, className }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-x-1.5", children: [!iconOnRight &&
                (icon !== null && icon !== void 0 ? icon : ((0, jsx_runtime_1.jsx)("i", { className: "ph ph-bold ph-link text-primary group-[.sidebar]:text-background" }))), (0, jsx_runtime_1.jsx)("a", { href: url.href, target: "_blank", rel: "noreferrer noopener nofollow", className: (0, utils_1.cn)("inline-block", className), children: label !== null && label !== void 0 ? label : (url.label || url.href) }), iconOnRight &&
                (icon !== null && icon !== void 0 ? icon : ((0, jsx_runtime_1.jsx)("i", { className: "ph ph-bold ph-link text-primary group-[.sidebar]:text-background" })))] }));
};
...
const Gengar = ({ columns, isFirstPage = false }) => {
    const [main, sidebar] = columns;
    const primaryColor = (0, artboard_1.useArtboardStore)((state) => state.resume.metadata.theme.primary);
    return ((0, jsx_runtime_1.jsxs)("div", { className: "grid min-h-[inherit] grid-cols-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: (0, utils_1.cn)("sidebar group flex flex-col", !(isFirstPage || sidebar.length > 0) && "hidden"), children: [isFirstPage && (0, jsx_runtime_1.jsx)(Header, {}), (0, jsx_runtime_1.jsx)("div", { className: "p-custom flex-1 space-y-4", style: { backgroundColor: (0, utils_1.hexToRgb)(primaryColor, 0.2) }, children: sidebar.map((section) => ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: mapSectionToComponent(section) }, section))) })] }), (0, jsx_runtime_1.jsxs)("div", { className: (0, utils_1.cn)("main group", sidebar.length > 0 ? "col-span-2" : "col-span-3"), children: [isFirstPage && (0, jsx_runtime_1.jsx)(Summary, {}), (0, jsx_runtime_1.jsx)("div", { className: "p-custom space-y-4", children: main.map((section) => ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: mapSectionToComponent(section) }, section))) })] })] }));
};
