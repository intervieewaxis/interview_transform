...
const Rating = ({ level }) => ((0, jsx_runtime_1.jsx)("div", { className: "flex items-center gap-x-1.5", children: Array.from({ length: 5 }).map((_, index) => ((0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("size-2 rounded-full border border-primary group-[.sidebar]:border-background", level > index && "bg-primary group-[.sidebar]:bg-background") }, index))) }));
const Link = ({ url, icon, iconOnRight, label, className }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-x-1.5", children: [!iconOnRight &&
                (icon !== null && icon !== void 0 ? icon : (0, jsx_runtime_1.jsx)("i", { className: "ph ph-bold ph-link text-primary group-[.sidebar]:text-white" })), (0, jsx_runtime_1.jsx)("a", { href: url.href, target: "_blank", rel: "noreferrer noopener nofollow", className: (0, utils_1.cn)("inline-block", className), children: label !== null && label !== void 0 ? label : (url.label || url.href) }), iconOnRight &&
                (icon !== null && icon !== void 0 ? icon : (0, jsx_runtime_1.jsx)("i", { className: "ph ph-bold ph-link text-primary group-[.sidebar]:text-white" }))] }));
};
...
const Section = ({ section, children, className, urlKey, levelKey, summaryKey, keywordsKey, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { id: section.id, className: "grid", children: [(0, jsx_runtime_1.jsx)("h4", { className: "mb-2 border-b pb-0.5 text-sm font-bold", children: section.name }), (0, jsx_runtime_1.jsx)("div", { className: "grid gap-x-6 gap-y-3", style: { gridTemplateColumns: `repeat(${section.columns}, 1fr)` }, children: section.items
                    ...
                    return ((0, jsx_runtime_1.jsxs)("div", { className: (0, utils_1.cn)("space-y-2", className), children: [(0, jsx_runtime_1.jsxs)("div", { children: [children === null || children === void 0 ? void 0 : children(item), url !== undefined && section.separateLinks && (0, jsx_runtime_1.jsx)(Link, { url: url })] }), summary !== undefined && !(0, utils_1.isEmptyString)(summary) && ((0, jsx_runtime_1.jsx)("div", { dangerouslySetInnerHTML: { __html: summary }, className: "wysiwyg group-[.sidebar]:prose-invert" })), level !== undefined && level > 0 && (0, jsx_runtime_1.jsx)(Rating, { level: level }), keywords !== undefined && keywords.length > 0 && ((0, jsx_runtime_1.jsx)("p", { className: "text-sm", children: keywords.join(", ") }))] }, item.id));
                }) })] }));
};
const Experience = () => {
...
const Certifications = () => {
    ...
    return ((0, jsx_runtime_1.jsx)(Section, { section: section, urlKey: "url", summaryKey: "summary", children: (item) => ((0, jsx_runtime_1.jsx)("div", { className: "flex items-start justify-between group-[.sidebar]:flex-col group-[.sidebar]:items-start", children: (0, jsx_runtime_1.jsxs)("div", { className: "text-left", children: [(0, jsx_runtime_1.jsx)("div", { className: "font-bold", children: item.name }), (0, jsx_runtime_1.jsx)(LinkedEntity, { name: item.issuer, url: item.url, separateLinks: section.separateLinks }), (0, jsx_runtime_1.jsx)("div", { className: "font-bold", children: item.date })] }) })) }));
};
const Skills = () => {
...
const Chikorita = ({ columns, isFirstPage = false }) => {
    const [main, sidebar] = columns;
    return ((0, jsx_runtime_1.jsxs)("div", { className: "grid min-h-[inherit] grid-cols-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: (0, utils_1.cn)("main p-custom group space-y-4", sidebar.length > 0 ? "col-span-2" : "col-span-3"), children: [isFirstPage && (0, jsx_runtime_1.jsx)(Header, {}), main.map((section) => ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: mapSectionToComponent(section) }, section)))] }), (0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("sidebar p-custom group h-full space-y-4 bg-primary text-background", sidebar.length === 0 && "hidden"), children: sidebar.map((section) => ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: mapSectionToComponent(section) }, section))) })] }));
};
