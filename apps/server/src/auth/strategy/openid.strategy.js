...
let OpenIDStrategy = (() => {
    ...
    let _classThis;
    let _classSuper = (0, passport_1.PassportStrategy)(passport_openidconnect_1.Strategy, "openid");
    var OpenIDStrategy = _classThis = class extends _classSuper {
        constructor(authorizationURL, callbackURL, clientID, clientSecret, issuer, tokenURL, userInfoURL, userService) {
            super({
                authorizationURL,
                callbackURL,
                clientID,
        ...
        validate(issuer, profile, done) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                const { displayName, emails, photos, username } = profile;
                const email = (_a = emails === null || emails === void 0 ? void 0 : emails[0].value) !== null && _a !== void 0 ? _a : `${username}@openid.com`;
    ...
    __setFunctionName(_classThis, "OpenIDStrategy");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        OpenIDStrategy = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return OpenIDStrategy = _classThis;
})();
