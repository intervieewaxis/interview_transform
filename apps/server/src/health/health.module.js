...
const browser_health_1 = require("./browser.health");
const database_health_1 = require("./database.health");
const health_controller_1 = require("./health.controller");
const storage_health_1 = require("./storage.health");
let HealthModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [terminus_1.TerminusModule, printer_module_1.PrinterModule, storage_module_1.StorageModule],
    ...
    let _classThis;
    var HealthModule = _classThis = class {
    };
