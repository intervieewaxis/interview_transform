...
let FeatureController = (() => {
    let _classDecorators = [(0, common_1.Controller)("feature")];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _getFeatureFlags_decorators;
    var FeatureController = _classThis = class {
        constructor(featureService) {
            this.featureService = (__runInitializers(this, _instanceExtraInitializers), featureService);
        }
        getFeatureFlags() {
            return this.featureService.getFeatures();
        }
    };
    __setFunctionName(_classThis, "FeatureController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _getFeatureFlags_decorators = [(0, common_1.Get)("/flags")];
        ...
        FeatureController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FeatureController = _classThis;
})();
