...
let UserService = (() => {
    ...
    var UserService = _classThis = class {
        ...
        findOneByIdentifier(identifier) {
            return __awaiter(this, void 0, void 0, function* () {
                const user = yield ((identifier) => __awaiter(this, void 0, void 0, function* () {
        ...
        findOneByIdentifierOrThrow(identifier) {
            return __awaiter(this, void 0, void 0, function* () {
                const user = yield ((identifier) => __awaiter(this, void 0, void 0, function* () {
                    // First, find the user by email
                    const user = yield this.prisma.user.findUnique({
        ...
        updateByResetToken(resetToken, data) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.prisma.secrets.update({ where: { resetToken }, data });
            });
        }
        deleteOneById(id) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this.storageService.deleteFolder(id);
