...
const two_factor_guard_1 = require("@/server/auth/guards/two-factor.guard");
let StorageController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)("Storage"), (0, common_1.Controller)("storage")];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _uploadFile_decorators;
    var StorageController = _classThis = class {
    ...
    __setFunctionName(_classThis, "StorageController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _uploadFile_decorators = [(0, common_1.Put)("image"), (0, common_1.UseGuards)(two_factor_guard_1.TwoFactorGuard), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)("file"))];
        ...
        StorageController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StorageController = _classThis;
})();
